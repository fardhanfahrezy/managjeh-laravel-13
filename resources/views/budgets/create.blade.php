<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Tetapkan Budget Baru</h1>
                <p class="text-xs text-gray-500 dark:text-gray-400">Tentukan batas maksimal pengeluaran bulanan per kategori.</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 sm:p-8">
            <form method="POST" action="{{ route('budgets.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="month" id="periode" name="periode" value="{{ old('periode', $periode) }}" class="mt-1.5 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required />
                ...
                <div>
                    ...
                    <div class="relative mt-1.5 rounded-xl shadow-sm">
                        ...
                        <input type="number" step="0.01" id="limit_bulanan" name="limit_bulanan" value="{{ old('limit_bulanan') }}" placeholder="Contoh: 1500000" class="block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white pl-12 pr-4 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm font-semibold" required />
                    </div>
