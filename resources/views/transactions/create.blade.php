    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">Pilih tipe transaksi untuk mencatat pemasukan, pengeluaran, atau transfer.</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ tipe: '{{ old('tipe', $defaultType) }}' }">
            ...
            <form method="POST" action="{{ route('transactions.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative mt-1.5 rounded-xl shadow-sm">
                        ...
                        <input type="number" step="0.01" id="jumlah" name="jumlah" value="{{ old('jumlah') }}" placeholder="0.00" class="block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white pl-12 pr-4 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-base font-semibold" required />
                    </div>
                ...
                <div>
                    ...
                    <input type="date" id="tanggal" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" class="mt-1.5 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required />
                ...
                <div>
                    ...
                    <textarea id="catatan" name="catatan" rows="3" placeholder="Contoh: Makan siang bersama rekan, Beli bensin..." class="mt-1.5 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('catatan') }}</textarea>
